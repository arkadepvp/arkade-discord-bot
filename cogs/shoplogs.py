...
class shopcharts:
    ...
    async def shopchart(self, ctx):
        ...
        time.sleep(.1)
        urllib.request.urlretrieve('ftp://' + ftp4 + '@147.135.30.58/Servers/S3C1M1-L2P-Center/ShooterGame/Binaries/Win64/ArkApi/Plugins/ArkShop/ShopLog_TheCenter.log', 'shoplogs/ShopLog_TheCenter.log')
        time.sleep(.1)
